...
| Name | What it does |
|---|---|
| [`azure-application-gateway`](plugins/azure-agent-skills/skills/azure-application-gateway/SKILL.md) | Expert knowledge for Azure Application Gateway development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding… |
| [`azure-artifacts`](plugins/azure-agent-skills/skills/azure-artifacts/SKILL.md) | Expert knowledge for Azure Artifacts development including best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when managing feeds, upstream… |
| [`azure-bastion`](plugins/azure-agent-skills/skills/azure-bastion/SKILL.md) | Expert knowledge for Azure Bastion development including best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, and integrations & coding patterns. Use when… |
| [`azure-boards`](plugins/azure-agent-skills/skills/azure-boards/SKILL.md) | Expert knowledge for Azure Boards development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, and integrations & coding patterns. Use when managing work items,… |
| [`azure-container-registry`](plugins/azure-agent-skills/skills/azure-container-registry/SKILL.md) | Expert knowledge for Azure Container Registry development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding… |
| [`azure-cost-management`](plugins/azure-agent-skills/skills/azure-cost-management/SKILL.md) | Expert knowledge for Cost Management development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when managing… |
| [`azure-ddos-protection`](plugins/azure-agent-skills/skills/azure-ddos-protection/SKILL.md) | Expert knowledge for Azure DDoS Protection development including troubleshooting, best practices, decision making, architecture & design patterns, security, configuration, and integrations & coding patterns. Use when… |
| [`azure-devops`](plugins/azure-agent-skills/skills/azure-devops/SKILL.md) | Expert knowledge for Azure DevOps development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and… |
...
| [`azure-rbac`](plugins/azure-agent-skills/skills/azure-rbac/SKILL.md) | Expert knowledge for Azure Role-based access control development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, and integrations & coding patterns. Use when… |
| [`azure-repos`](plugins/azure-agent-skills/skills/azure-repos/SKILL.md) | Expert knowledge for Azure Repos development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, and integrations & coding patterns. Use… |
| [`azure-resource-manager`](plugins/azure-agent-skills/skills/azure-resource-manager/SKILL.md) | Expert knowledge for Azure Resource Manager development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding… |
| [`azure-virtual-network`](plugins/azure-agent-skills/skills/azure-virtual-network/SKILL.md) | Expert knowledge for Azure Virtual Network development including best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, and deployment. Use when configuring VNet… |
| [`azure-vpn-gateway`](plugins/azure-agent-skills/skills/azure-vpn-gateway/SKILL.md) | Expert knowledge for Azure VPN Gateway development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns,… |
| [`azure-web-application-firewall`](plugins/azure-agent-skills/skills/azure-web-application-firewall/SKILL.md) | Expert knowledge for Azure Web Application Firewall development including best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring… |
| [`azure-well-architected`](plugins/azure-agent-skills/skills/azure-well-architected/SKILL.md) | Expert guidance for designing, assessing, and optimizing Azure workloads using Azure Well Architected. Covers design review checklists, recommendations, design principles, tradeoffs, service guides, workload patterns,… |
